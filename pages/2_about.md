...
## About the site
This is a personal website of duyn, created with github and jekyll. 
Create your own website is as easy as clone or fork a [template](https://github.com/duyn/duyn.github.io) on github, and [commit](http://jekyllrb.com/docs/posts/) to `_posts` folder. 

### Admin tools
* site [configuration file](https://github.com/duyn/duyn.github.io/blob/master/_config.yml)
